...
TextStyle _t(double size, FontWeight w, Color c,
    ...
    TextStyle(
      ...
      height: height,
      fontFamily: 'Georgia', // Elegant serif — swap to any Google Font you prefer
    );
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        _Tab(label: 'Create account', active: !isLogin, onTap: () => onSwitch(false)),
      ],
    );
  }
}
...
class _LoginFields extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        _Field(controller: email, hint: 'Email address', icon: Icons.mail_outline_rounded),
        const SizedBox(height: 12),
        _Field(
          controller: password,
          hint: 'Password',
...
class _RegisterFields extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        _Field(controller: name, hint: 'Full name', icon: Icons.person_outline_rounded),
        const SizedBox(height: 12),
        _Field(controller: email, hint: 'Email address', icon: Icons.mail_outline_rounded),
        const SizedBox(height: 12),
        _Field(
